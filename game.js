...
var effect = powerup[index].effect;
if (effect === 'gravity') {
    gravity = 0.4;
    player.speed = 4;
    player.color = 'white';
...
if (powerup[index].stay !== true) {
    powerup.splice(index, 1); // Remove the collected powerup from the array
}
}
...
// Call updateScore() when the page loads to initialize the score display
